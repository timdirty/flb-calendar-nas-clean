...
// 引入依賴（Node.js 環境）
let _drivePathSemesterHelper, _drivePathDateFormatter, _drivePathCourseNameCleaner;
if (typeof require !== 'undefined') {
    _drivePathSemesterHelper = require('./semester-helper');
    _drivePathDateFormatter = require('./date-formatter');
    _drivePathCourseNameCleaner = require('./course-name-cleaner');
}
...
class DrivePathHelper {
    ...
    constructor(driveRoot = '/Fun Learn Bar/FLB-Learning-Portfolio') {
        ...
        this.semesterHelper = _drivePathSemesterHelper || (typeof window !== 'undefined' ? window.SemesterHelper : null);
        this.dateFormatter = _drivePathDateFormatter || (typeof window !== 'undefined' ? window.DateFormatter : null);
        this.courseNameCleaner = _drivePathCourseNameCleaner || (typeof window !== 'undefined' ? window.CourseNameCleaner : null);
    }
